 ...
 * @subpackage Example
 * @version    2.5.2 for plugin Hyper-WP
...
function hyper_wp_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'hyper-wp' ),  // %1$s = plugin name(s).
